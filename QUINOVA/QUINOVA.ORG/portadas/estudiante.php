...
session_start();
    $id=$_SESSION['ci'];
    $sql1="SELECT codigo,nombre, c.cuenta_User, c.id FROM clases c , registroClase r, cuenta cu WHERE
c.id = r.clases_id AND cu.User = r.cuenta_User AND cu.User =". $id . ";";
  ...
  <header>
    ...
    <div id="mas">
      ...
      <nav id="botones">
        ...
        <a href="cerrarSesion.php" id="cerrar">Cerrar sesion</a>
      </nav>
    </div>
  </header>
...
<?php
      if($resultado1->num_rows>0){
        ...
        echo "<a href='materia.php?id=".$fila1['id'];
        echo "<div class='materia'>";
        echo "<div class='superior'><strong>".$nombreClase. "</strong><br>".$codigo. "</div>";
        echo "<div class='inferior'></div>";
        echo " </div> </a>";
        }
    }
?>
